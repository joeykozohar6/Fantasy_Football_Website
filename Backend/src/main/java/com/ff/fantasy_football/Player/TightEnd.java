...
/**
 * Class to represent a tight end in the databse
 */
@Entity
...
public class TightEnd extends Player {
    ...
    public TightEnd(String name, String position, Integer gamesPlayed, Double fantasyPoints, Double fantasyPointsPerGame, Double percentRostered, Double rushingAttempts, Double rushingYards, Double rushingTouchdowns, Double fumblesLost, Double receptions, Double targets, Double receivingYards, Double yardsPerReception, Double receivingTouchdowns, Double longestReception, Double receptions20PlusYards) {
