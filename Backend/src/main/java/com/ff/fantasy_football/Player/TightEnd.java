...
public class TightEnd extends Player {
    ...
    public TightEnd(String name, Integer gamesPlayed, Double fantasyPoints, Double fantasyPointsPerGame, Double percentRostered, Double rushingAttempts, Double rushingYards, Double rushingTouchdowns, Double fumblesLost, Double receptions, Double targets, Double receivingYards, Double yardsPerReception, Double receivingTouchdowns, Double longestReception, Double receptions20PlusYards) {
